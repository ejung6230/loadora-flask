...
def fallback():
    ...
    try:
        ...
        if synergy_match:
            ...
            # 직업 데이터 딕셔너리 (모든 직업 포함)
            job_data = {
                # 전사 (슈샤이어)
                "워로드": {"codes": ["워로드", "ㅇㄹㄷ"], "synergy_info": "방감 12, 피증4, 백헤드5"},
                "디트": {"codes": ["디트", "ㄷㅌ"], "synergy_info": "방감 12"},
                "버서커": {"codes": ["버서커", "ㅂㅅㅋ"], "synergy_info": "피증 6"},
                "슬레이어": {"codes": ["슬레이어", "ㅅㄹㅇ"], "synergy_info": "피증 6"},
                # 무도가 (애니츠)
                "창술사": {"codes": ["창술", "ㅊㅅ"], "synergy_info": "치명타 시 피증 8"},
                "배틀마스터": {"codes": ["배마", "ㅂㅁ"], "synergy_info": "치적 10, 공속 8, 이속 16"},
                "스커": {"codes": ["스커", "ㅅㅋ"], "synergy_info": "치적 10, 공속 8"},
                "인파이터": {"codes": ["인파", "ㅇㅍ"], "synergy_info": "피증 6"},
                "브루저": {"codes": ["브커", "ㅂㅋ"], "synergy_info": "피증 6"},
                "기공사": {"codes": ["기공", "ㄱㄱ"], "synergy_info": "공증 6"},
                # 헌터 (아르데타인)
                "데헌": {"codes": ["데헌", "ㄷㅎ"], "synergy_info": "치적 10"},
                "건슬링거": {"codes": ["건슬", "ㄱㅅ"], "synergy_info": "치적 10"},
                "호크아이": {"codes": ["호크", "ㅎㅋ"], "synergy_info": "피증 6, 이속 4(두동)"},
                "블래스터": {"codes": ["블래", "ㅂㄹ"], "synergy_info": "방감 12"},
                "스카우터": {"codes": ["스카", "ㅅㅋ"], "synergy_info": "공증 6"},
                # 마법사 (실린)
                "서머너": {"codes": ["서머너", "ㅅㅁㄴ"], "synergy_info": "방감 12, 마나회복 40 (트포 선택)"},
                "알카나": {"codes": ["알카", "ㅇㄹㅋ"], "synergy_info": "치적 10"},
                "소서리스": {"codes": ["소서", "ㅅㅅ"], "synergy_info": "피증 6"},
                # 암살자 (데런)
                "리퍼": {"codes": ["리퍼", "ㄹㅍ"], "synergy_info": "방감12"},
                "데모닉": {"codes": ["데모닉", "ㄷㅁㄴ"], "synergy_info": "피증 6"},
                "소울브링어": {"codes": ["소울", "ㅅㅇ"], "synergy_info": "피증 6"},
                "블레이드": {"codes": ["블레", "ㅂㄹ"], "synergy_info": "피증 4, 백헤드 5, 공속 25, 이속 20"},
                # 스페셜리스트 (요즈)
            ...
            if not job_input or not matched_job:
                ...
                # 매칭 성공 → 해당 직업 시너지 정보
                response_text = f"""◕ᴗ◕🌸\n'{matched_job}' 직업의 시너지 정보를 알려드릴게요\n{job_data[matched_job]['synergy_info']}"""
