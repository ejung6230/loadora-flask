...
def fallback():
    ...
    try:
        ...
        if synergy_match:
            ...
            job_data = {
                "전사 (슈샤이어)": {
                    "워로드": {"codes": ["워로드", "ㅇㄹㄷ"], "synergy_info": "방감 12, 받피증4, 백헤드5"},
                    "디트": {"codes": ["디스트로이어", "ㄷㅅㅌㄹㅇㅇ", "디트", "ㄷㅌ"], "synergy_info": "방감 12"},
                    "버서커": {"codes": ["버서커", "ㅂㅅㅋ"], "synergy_info": "받피증 6"},
                    "슬레이어": {"codes": ["슬레이어", "ㅅㄹㅇㅇ", "슬레", "ㅅㄹ"], "synergy_info": "받피증 6"},
                    "홀리나이트": {"codes": ["홀리나이트", "ㅎㄹㄴㅇㅌ", "홀나", "ㅎㄴ"], "synergy_info": "서포터 업데이트 필요"},
                    "발키리": {"codes": ["발키리", "ㅂㅋㄹ"], "synergy_info": "서포터 업데이트 필요"},
                },
                "무도가 (애니츠)": {
                    "창술사": {"codes": ["창술사", "ㅊㅅㅅ", "창술", "ㅊㅅ"], "synergy_info": "치명타 시 받피증 8"},
                    "배틀마스터": {"codes": ["배틀마스터", "ㅂㅌㅁㅅㅌ", "배마", "ㅂㅁ"], "synergy_info": "치적 10, 공속 8, 이속 16"},
                    "스트라이커": {"codes": ["스트라이커", "ㅅㅌㄹㅇㅋ", "스커", "ㅅㅋ"], "synergy_info": "치적 10, 공속 8"},
                    "인파이터": {"codes": ["인파이터", "ㅇㅍㅇㅌ", "인파", "ㅇㅍ"], "synergy_info": "받피증 6"},
                    "브레이커": {"codes": ["브레이커", "ㅂㄹㅇㅋ", "브커", "ㅂㅋ"], "synergy_info": "받피증 6"},
                    "기공사": {"codes": ["기공사", "ㄱㄳ", "ㄱㄱㅅ", "기공", "ㄱㄱ"], "synergy_info": "공증 6"},
                },
                "헌터 (아르데타인)": {
                    "데빌헌터": {"codes": ["데빌헌터", "ㄷㅂㅎㅌ", "데헌", "ㄷㅎ"], "synergy_info": "치적 10"},
                    "건슬링어": {"codes": ["건슬링어", "ㄳㄹㅇ", "ㄱㅅㄹㅇ", "건슬", "ㄱㅅ"], "synergy_info": "치적 10"},
                    "호크아이": {"codes": ["호크아이", "ㅎㅋㅇㅇ", "호크", "ㅎㅋ"], "synergy_info": "받피증 6, 이속 4(두동)"},
                    "블래스터": {"codes": ["블래스터", "ㅂㄽㅌ", "ㅂㄹㅅㅌ", "블래", "ㅂㄹ"], "synergy_info": "방감 12"},
                    "스카우터": {"codes": ["스카우터", "ㅅㅋㅇㅌ", "스카", "ㅅㅋ"], "synergy_info": "공증 6"},
                },
                "마법사 (실린)": {
                    "서머너": {"codes": ["서머너", "ㅅㅁㄴ"], "synergy_info": "방감 12, 마나회복 40 (트포 선택)"},
                    "아르카나": {"codes": ["아르카나", "ㅇㄹㅋㄴ", "알카", "ㅇㅋ"], "synergy_info": "치적 10"},
                    "소서리스": {"codes": ["소서리스", "ㅅㅅㄹㅅ", "소서", "ㅅㅅ"], "synergy_info": "받피증 6"},
                    "바드": {"codes": ["바드", "ㅂㄷ"], "synergy_info": "서포터 업데이트 필요"},
                },
                "암살자 (데런)": {
                    "리퍼": {"codes": ["리퍼", "ㄹㅍ"], "synergy_info": "방감12"},
                    "데모닉": {"codes": ["데모닉", "ㄷㅁㄴ"], "synergy_info": "받피증 6"},
                    "소울이터": {"codes": ["소울이터", "ㅅㅇㅇㅌ", "소울", "ㅅㅇ"], "synergy_info": "받피증 6"},
                    "블레이드": {"codes": ["블레이드", "ㅂㄹㅇㄷ", "블레", "ㅂㄹ"], "synergy_info": "받피증 4, 백헤드 5, 공속 25, 이속 20"},
                },
                "스페셜리스트 (요즈)": {
                    "기상술사": {"codes": ["기상", "ㄱㅅ"], "synergy_info": "치적 10, 공속 12(질풍), 이속 12(질풍), 공감 10(이슬비)"},
                    "환수사": {"codes": ["환수사", "ㅎㅅㅅ"], "synergy_info": "방감 12"},
                    "도화가": {"codes": ["도화가", "ㄷㅎㄱ"], "synergy_info": "서포터 업데이트 필요"},
                },
            }
...
"""
                ...
                for ark in armory_arkpassive:
                    effects.extend(ark.get("Effects", []))
