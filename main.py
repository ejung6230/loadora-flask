...
def fallback():
    try:
        ...
        if match_notice:
            ...
            if not server_down and all_notices:  # ✅ 서버 점검이 아닐 때만 공지 정리
                ...
                items = [
                    {
                        "simpleText": {
                            "text": f"◕ᴗ◕🌸 최신 {len(cards)}개의 공지를 보여드릴게요.\n\n",
                            "extra": {}
                        }
                    },
                    {
        ...
        if match_adventure_island:
            ...
            response_text = "◕ᴗ◕🌸 모험섬 정보를 보여드릴게요.\n\n"
        ...
        if match_event:
            ...
            try:
                ...
                if not events:
                    ...
                    response_text = "◕ᴗ◕🌸 이벤트 정보를 보여드릴게요.\n\n"
                    cards = []
        ...
        if match_merchant:
            ...
            # 떠상 요약 텍스트 생성
            response_text = "◕ᴗ◕🌸 전체 서버 떠상 정보를 보여드릴게요.\n\n"
        ...
        if match_cleargold:
            ...
            if not dungeon_name:
                ...
                response_text = "◕ᴗ◕🌸 던전 클골 정보를 보여드릴게요.\n\n"
        ...
        if match_info:
            ...
            if not info_char_name:
                ...
                response_text = f"◕ᴗ◕🌸 [{info_char_name}]님의 캐릭터 정보를 보여드릴게요.\n\n"
...
def korlark_summary():
    try:
        ...
        current_data = filter_active_reports(all_data)
        summary_text = "◕ᴗ◕🌸 전체 서버 떠상 정보를 보여드릴게요.\n\n"
